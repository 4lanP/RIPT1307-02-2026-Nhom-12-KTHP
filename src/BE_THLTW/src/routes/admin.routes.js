...
router.post('/reports/daily-email/send-now', authorizeStaffRoles(ADMIN_ROLES), validate(sendImmediateDailyRevenueEmailSchema), adminController.sendImmediateDailyRevenueEmail);
